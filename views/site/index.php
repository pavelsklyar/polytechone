...
<div class="container">
    <main>
        ...
        <!--Основная информация-->
        <div class="text_bar">
            <div class="text_h1">Polytech:ONE</div>
            <div class="text_5">
                Первая студенческая команда Московского Политехнического университета, которая
                готовит автомобиль к участию в российской серии кольцевых гонок.
            </div>
        </div>
    </main>
    <!--Футер-->
    <div class="main_footer">
        <div class="location">
            ...
            <div class="loc_text">Большая Семеновская, 38</div>
        </div>
        <div class="phone">
            <div class="phone_img"><img class="phone_img" src="images/phone.png" alt="phone"></div>
            <div class="tel">8 (495) 223-05-23 доб 1354</div>
        </div>
    </div>
</div>